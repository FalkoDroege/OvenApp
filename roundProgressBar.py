...
class TstWidget(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.bar.setDonutThicknessRatio(0.9)
        ...
        self.bar.setDataColors([(0., QtGui.QColor.fromRgb(50,50,255)), (0.5, QtGui.QColor.fromRgb(0,0,255)), (1., QtGui.QColor.fromRgb(100,100,255))])

        self.bar.setRange(0, 360)
        self.bar.setValue(350)
